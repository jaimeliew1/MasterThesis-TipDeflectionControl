...
def _run(dlc1, dlc2, dlc3, dlc4, wsp=20, SAVE=None):
    ...
    # labels
    fig.text(0.45, -0.1, 'Azimuth Angle [deg]', ha='center', rotation='horizontal')
    ...
    for i, key in enumerate(azim1.keys()):
        ...
        ax.annotate(f'$A_r={i}m$' , xy=(0.5, 0.01),
...
#                bbox=dict(ec='w', fc='w', alpha=0.0))
    ...
    axes[0].legend(loc='upper left', fontsize=8, numpoints=10)
